            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <div align="right">
                        <!-- <a href="<?php echo base_url('admin/dashboard/hapus_pesanan');?>"> <div class="btn btn-danger btn-sm">Hapus Pesanan</div></a>  -->
                        <a href="<?php echo base_url('admin/dashboard/');?>"> <div class="btn btn-primary btn-sm">Pesan lagi</div></a> 
                        <a href="<?php echo base_url('admin/dashboard/pembayaran');?>"> <div class="btn btn-success btn-sm">Pembayaran</div></a> 
                        </div>
                    </div>
                </div>
            </div>
...
function update_item_keranjang(obj, rowid){
    $.get("<?php echo base_url('admin/dashboard/update_jumlah_menu/'); ?>", {rowid:rowid, qty:obj.value}, function(resp){
        if(resp == 'ok'){
            location.reload();
        }else{

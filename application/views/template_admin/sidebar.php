  ...
  <div id="app">
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <li class="nav-item">
        <?php
        $pesanan = '<li class="dropdown"><a href="' . site_url('admin/dashboard/detail_pesanan') . '" class="nav-link nav-link-lg nav-link-user"><div class="d-sm-none d-lg-inline-block">Pesanan: '.$this->cart->total_items().' items</div></a></li>';
        echo $pesanan;
        ?>
        </li>     
        ...
        <ul class="sidebar-menu">
          <li class="menu-header">Dashboard</li>
              <li class="nav-item <?php echo $this->uri->segment(2) == 'dashboard' ? 'active' : '' ?>">
                <a href="<?php echo base_url()?>admin/dashboard" class="nav-link"><i class="fas fa-utensils"></i> <span>Menu</span></a>
              </li>
              <li class="nav-item <?php echo $this->uri->segment(2) == 'antrian' ? 'active' : '' ?>">
                <a href="<?php echo base_url()?>admin/antrian" class="nav-link"><i class="far fa-file-alt"></i> <span>Antrian</span></a>
              </li>
              <li class="nav-item <?php echo $this->uri->segment(2) == 'laporan' ? 'active' : '' ?>">
                <a href="<?php echo base_url()?>admin/laporan" class="nav-link"><i class="fas fa-file-alt"></i> <span>Laporan</span></a>
              </li>
              <li class="menu-header">Data Master</li>
              <li class="nav-item <?php echo $this->uri->segment(2) == 'data_menu' ? 'active' : '' ?>">
              <a href="<?php echo base_url()?>admin/data_menu" class="nav-link"><i class="far fa-user"></i> <span>Data Menu</span></a>
              </li>
              <li class="nav-item <?php echo $this->uri->segment(2) == 'data_karyawan' ? 'active' : '' ?>">
              <a href="<?php echo base_url()?>admin/data_karyawan"  class="nav-link"><i class="far fa-user"></i> <span>Data Karyawan</span></a>
              </li>
